...
[
  ...
  { title: "Enviar relatório", description: "Relatório mensal", status: :overdue, due_date: Date.today - 3 },
  { title: "Limpar mesa", description: "Organizar papéis", status: :completed, due_date: Date.today - 1 },
  ...
  { title: "Preparar aula", description: "Conteúdo de Rails", status: :completed, due_date: Date.today - 5 },
  ...
  { title: "Revisar código", description: "Pull request", status: :completed, due_date: Date.today - 2 },
